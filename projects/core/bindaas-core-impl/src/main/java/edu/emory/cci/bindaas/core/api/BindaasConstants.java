...
public interface BindaasConstants {

	public final static String HOST = "host";
	public final static String PORT = "port";
	public final static String PROTOCOL = "protocol";
	public final static String AUTHENTICATION_STATUS = "authentication.status";
	public final static String AUTHENTICATION_PROVIDER = "authentication.provider.class";
	public final static String AUTHORIZATION_STATUS = "authorization.status";
