package edu.emory.cci.bindaas.datasource.provider.drill;

import org.apache.drill.jdbc.Driver;

import edu.emory.cci.bindaas.datasource.provider.drill.bundle.Activator;
...
public class DrillProvider extends AbstractSQLProvider{
	...
	public Driver getDatabaseDriver() throws Exception {
		if(driver == null)
		{
			driver = new org.apache.drill.jdbc.Driver();
		}
		return driver;
	}
