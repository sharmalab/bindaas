...
/**
 *  applies to angular and ruler shapes
 * @author nadir
 *
 */

public class MultiPointShapeHandler implements IShapeHandler{

	private String xpathExpression = "/ns1:ImageAnnotation/ns1:geometricShapeCollection/ns1:GeometricShape[@xsi:type='MultiPoint']";
