# Bindaas 3.3.1 Docker Container


## For the Bindaas User: Running the Docker Container

$ docker run --name bindaas-3 -p 8080:8080 -p 9099:9099 pradeeban/bindaas:3.3.1 


You may instead want to run Bindaas with the configuration files from the host.


$ docker run --name bindaas-public -v /home/ex-pradeebankathira/publ/projects:/root/bindaas/bin/projects -v /home/ex-pradeebankathira/publ/bindaas.config.json:/root/bindaas/bin/bindaas.config.json -p 8080:8080 -p 9099:9099 pradeeban/bindaas:3.3.1

$ docker run --name bindaas-public -v /Users/llovizna/projects:/root/bindaas/bin/projects -p 8080:8080 -p 9099:9099 pradeeban/bindaas:3.3.1
...
$ docker build -t bindaas:3.3.1 .

You will get the output "Successfully tagged bindaas:3.3.1" if everything went fine.
...
bindaas             3.3.1              a9a81d677bb2        5 minutes ago       359MB



### Tag the image with the user name:
 
 $ docker tag bindaas:3.3.1 pradeeban/bindaas:3.3.1
...
Before committing, make sure Bindaas runs fine in the container using the command above listed under the "For the Bindaas User" section.
 ...
 $ docker push pradeeban/bindaas:3.3.1
